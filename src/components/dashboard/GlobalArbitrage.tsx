...
export function GlobalArbitrage() {
  ...
  return (
    <div className="bg-[var(--background)] border border-black/5 rounded-2xl p-6 md:p-8 h-full flex flex-col relative overflow-hidden">
      {/* Background Graphic */}
      <Globe className="absolute -bottom-10 -right-10 w-64 h-64 text-gray-900/[0.02] pointer-events-none" strokeWidth={1} />
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-white/50 border border-black/5 rounded-xl p-4">
          <div className="text-gray-600 text-xs font-semibold tracking-widest mb-4">UAE MARKET</div>
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-gray-500">Gold Price</span>
              <span className="text-gray-900 font-mono">{uaePriceAed} AED</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Exchange Rate</span>
              <span className="text-gray-900 font-mono">{exchangeRate}</span>
            </div>
            <div className="pt-3 border-t border-black/5 flex justify-between font-medium">
              <span className="text-gray-600">Adjusted Cost</span>
              <span className="text-gray-900 font-mono">₹{uaePriceInr.toLocaleString(undefined, { maximumFractionDigits: 0 })}</span>
            </div>
          </div>
        </div>

        <div className="bg-white/50 border border-black/5 rounded-xl p-4">
          <div className="text-gray-600 text-xs font-semibold tracking-widest mb-4">INDIA MARKET</div>
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-gray-500">Gold Price</span>
              <span className="text-gray-900 font-mono">₹{indiaPriceInr.toLocaleString()}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="pt-3 border-t border-black/5 flex justify-between font-medium">
              <span className="text-gray-600">Adjusted Cost</span>
              <span className="text-gray-900 font-mono">₹{indiaPriceTotalInr.toLocaleString(undefined, { maximumFractionDigits: 0 })}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Result */}
      <div className="mt-auto border border-black/5 bg-white/5 rounded-xl p-5 flex items-center justify-between">
        <div>
