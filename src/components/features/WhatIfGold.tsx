  ...
  return (
    <GlassPanel>
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm text-gray-400 mb-1">Investment Amount (AED)</label>
          <input 
            type="number"
            value={investment}
        ...
        <div>
          <label className="block text-sm text-gray-400 mb-1">Years Ago</label>
          <input 
            type="range"
            min="1"
            max="20"
        ...
        <div className="pt-4 border-t border-[var(--panel-border)]">
          <div className="grid grid-cols-2 gap-4 text-center">
            <div className="bg-black/30 p-4 rounded-xl border border-[var(--panel-border)]">
              <div className="text-gray-400 text-xs uppercase tracking-wider mb-1">Current Value</div>
              <div className="text-xl font-semibold text-white">
                AED {currentValue.toLocaleString(undefined, { maximumFractionDigits: 0 })}
              </div>
            </div>
            <div className="bg-black/30 p-4 rounded-xl border border-[var(--panel-border)]">
              <div className="text-gray-400 text-xs uppercase tracking-wider mb-1">Total Return</div>
