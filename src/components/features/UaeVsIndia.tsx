    ...
    <GlassPanel>
      ...
      <div className="space-y-4 pt-4 border-t border-[var(--panel-border)]">
        <div className="flex justify-between items-center">
          <span className="text-gray-600">Price in UAE:</span>
          <span className="font-medium text-gray-900">AED {uaePriceTotalAed.toLocaleString(undefined, { maximumFractionDigits: 2 })}</span>
        </div>
        <div className="flex justify-between items-center">
          <span className="text-gray-600">Price in India (incl. Duty):</span>
          <span className="font-medium text-gray-900">AED {indiaPriceTotalAed.toLocaleString(undefined, { maximumFractionDigits: 2 })}</span>
        </div>
